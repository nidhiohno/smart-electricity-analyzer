...
def section_header(icon, title, subtitle=""):
    ...
    <div style="display:flex;align-items:center;gap:14px;margin:28px 0 20px;padding-bottom:16px;
      ...
      <div>
        <div style="font-family:'Syne',sans-serif;font-size:19px;font-weight:700;color:#f9fafb;letter-spacing:-.2px;">{title}</div>
        {sub_html}
      </div>
    </div>
...
def stat_card(label, value, icon="", color="#38bdf8"):
    ...
    <div style="background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.07);
      ...
      <div style="font-size:10px;color:#6b7280;font-weight:600;text-transform:uppercase;
        letter-spacing:1.2px;font-family:'DM Sans',sans-serif;">{icon} {label}</div>
...
def alert_card(bg_color, border_color, content):
    ...
    <div style="background:{bg_color};border-left:4px solid {border_color};
      ...
      font-family:'DM Sans',sans-serif;line-height:1.5;">{content}</div>
    ''', unsafe_allow_html=True)
...
/* ══ BASE ══ */
html,body{font-family:'DM Sans',sans-serif!important;background:#020c18!important}
...
[data-testid="metric-container"] [data-testid="stMetricValue"]{
  ...
  font-family:'Syne',sans-serif!important;letter-spacing:-.5px!important;
}
...
if not st.session_state.logged_in:
    ...
    <div style="min-height:180px;display:flex;flex-direction:column;align-items:center;justify-content:center;padding:48px 0 32px;position:relative;">
        ...
        <div style="font-size:11px;color:#4b5563;margin-top:10px;letter-spacing:3px;font-family:'DM Sans',sans-serif;font-weight:500;">
...
if st.session_state.page == "input":
    ...
    if st.session_state.get("just_saved"):
            ...
            if alert_data:
                ...
                if total_possible_saving > 0:
                    st.markdown(f'''<div style="background:linear-gradient(135deg,rgba(16,185,129,.2),rgba(5,150,105,.1));
                      ...
                      <div style="font-family:'Syne',sans-serif;font-size:32px;font-weight:800;color:#34d399;">Rs {total_possible_saving:.0f}</div>
        ...
        <div style="background:linear-gradient(135deg,rgba(255,255,255,.04),rgba(255,255,255,.02));
          ...
          <div style="font-size:22px;font-weight:800;color:#f9fafb;font-family:'Syne',sans-serif;">
